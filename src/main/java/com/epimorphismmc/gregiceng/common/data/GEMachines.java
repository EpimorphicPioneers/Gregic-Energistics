...
public class GEMachines {
    public static final PartAbility[] IO_BUFFER_ABILITIES = new PartAbility[] {
    ...
    public static final MachineDefinition STOCKING_BUS = registrate()
            .machine("stocking_bus", StockingBusPartMachine::new)
            .tier(EV)
    ...
    public static final MachineDefinition STOCKING_HATCH = registrate()
            .machine("stocking_hatch", StockingHatchPartMachine::new)
            .tier(EV)
            .rotationState(RotationState.ALL)
    ...
    public static final MachineDefinition ADV_STOCKING_BUS = registrate()
            .machine("adv_stocking_bus", AdvStockingBusPartMachine::new)
            .tier(IV)
            .rotationState(RotationState.ALL)
            .abilities(PartAbility.IMPORT_ITEMS)
            .renderer(() -> new CustomWorkableMachineRenderer(
    ...
    public static final MachineDefinition ADV_STOCKING_HATCH = registrate()
            .machine("adv_stocking_hatch", AdvStockingHatchPartMachine::new)
            .tier(IV)
            .rotationState(RotationState.ALL)
            .abilities(PartAbility.IMPORT_FLUIDS)
            .renderer(() -> new CustomWorkableMachineRenderer(
    ...
    public static final MachineDefinition CRAFTING_IO_BUFFER = registrate()
            .machine("crafting_io_buffer", CraftingIOBufferPartMachine::new)
            .tier(LuV)
            .rotationState(RotationState.ALL)
            .abilities(
    ...
    public static final MachineDefinition CRAFTING_IO_SLAVE = registrate()
            .machine("crafting_io_slave", CraftingIOSlavePartMachine::new)
            .tier(LuV)
            .rotationState(RotationState.ALL)
            .abilities(
                    GEConfigHolder.INSTANCE.enableMoreAbility
    ...
    public static final MachineDefinition[] OUTPUT_BUFFER = registerTieredGEMachines(
            "output_buffer",
            ...
            (tier, builder) -> builder
                    ...
                    .abilities(
                            GEConfigHolder.INSTANCE.enableMoreAbility
                                    ? OUTPUT_BUFFER_ABILITIES
                                    : new PartAbility[] {PartAbility.EXPORT_ITEMS})
                    .overlayTieredHullRenderer("buffer.export")
                    .tooltips(
                            Component.translatable("block.gregiceng.output_buffer.desc"),
                            Component.translatable(
                                    "gtceu.universal.tooltip.item_storage_capacity",
                                    (1 + Math.min(9, tier)) * (1 + Math.min(9, tier))),
                            Component.translatable(
    ...
    public static MachineDefinition[] registerTieredGEMachines(
            String name,
