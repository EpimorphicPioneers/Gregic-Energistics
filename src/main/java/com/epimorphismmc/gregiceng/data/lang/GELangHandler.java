...
public class GELangHandler {
    ...
    public static void init(MOLangProvider provider) {
        provider.addBlockWithTooltip(
                ...
                List.of("需与ME网络连接，可容纳54个样板", "拥有9个物品和流体催化剂槽", "允许回流至网络"));
        ...
        provider.addBlockWithTooltip(
                ...
                "ME存储输入总线",
                List.of("Using items in the ME network to provide items to multi block structures"),
                List.of("使用ME网络中的物品向多方块结构提供物品"));

        provider.addBlockWithTooltip(
                STOCKING_HATCH::getBlock,
                "ME Stocking Input Hatch",
                "ME存储输入仓",
                List.of("Using fluids in the ME network to provide fluids to multi block structures"),
                List.of("使用ME网络中的流体向多方块结构提供流体"));
        ...
        provider.addBlockWithTooltip(
                ...
                List.of("使用ME网络中的物品向多方块结构提供物品", "拥有自动拉取功能"));
        ...
        provider.addBlockWithTooltip(
                ...
                List.of(
                        ...
                        "Has Automatic pull mode"),
                List.of("使用ME网络中的流体向多方块结构提供流体", "拥有自动拉取功能"));
        ...
        provider.add("gui.gregiceng.share_inventory.desc", "Open share inventory", "打开共享库存");

        provider.add("gui.gregiceng.share_tank.title", "Share Tank", "共享储罐");
        provider.add("gui.gregiceng.share_tank.desc", "Open share tank", "打开共享储罐");

        provider.add("gui.gregiceng.refund_all.desc", "Refund raw materials in full", "退回所有材料");

        provider.add(
                "gui.gregiceng.automatic_return.desc.enabled", "Automatic Return is on", "自动回流已开启");
        provider.add(
                "gui.gregiceng.automatic_return.desc.disabled", "Automatic Return is disabled", "自动回流已禁用");
        ...
        provider.add(
                "config.gregiceng.option.enableMoreAbility",
