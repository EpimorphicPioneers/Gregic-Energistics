    ...
    default void attachConfigurators(ConfiguratorPanel configuratorPanel) {
        configuratorPanel.attachConfigurators(new IFancyConfiguratorButton.Toggle(
            ...
            .setTooltipsSupplier(pressed -> List.of(
                Component.translatable(pressed ? "gui.gregiceng.auto_pull_me.desc.enabled" : "gui.gregiceng.auto_pull_me.desc.disabled")
            )));
        configuratorPanel.attachConfigurators(new LongInputFancyConfigurator("gui.gregiceng.min_pull_amount", GuiTextures.SLOT, this::getMinPullAmount, this::setMinPullAmount));
    }
}
